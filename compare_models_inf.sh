...
# compare RADE V1 candidate2 to RADE V1 candidate3 (prototyped in dr-asr branch). Tracking down training issue
# discovered in HF RADE paper review, mapping of z elements to symbols.
if [ $plot == "250503_inf" ]; then
  run_model model19_check3 80 100 awgn 0 --cp 0.004 --time_offset -16 --auxdata --pilots --pilot_eq --eq_ls
  run_model model19_check3 80 100 mpp 0 --cp 0.004 --time_offset -16 --auxdata --pilots --pilot_eq --eq_ls --g_file g_mpp.f32
  run_model 250502 60 200 awgn 0 --cp 0.004 --time_offset -16 --auxdata --pilots --pilot_eq --eq_ls
  run_model 250502 60 200 mpp 0 --cp 0.004 --time_offset -16 --auxdata --pilots --pilot_eq --eq_ls --g_file g_mpp.f32

  model_list='model19_check3_awgn_0Hz model19_check3_mpp_0Hz 250502_awgn_0Hz 250502_mpp_0Hz'
  declare -a model_legend=("cand2 model19_check3 AWGN d=80 Nc=30" "cand2 model19_check3 MPP d=80 Nc=30" \
                           "cand3 250502 AWGN d=60 Nc=30" "cand3 250502 MPP d=60 Nc=30")
fi
