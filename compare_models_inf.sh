#!/bin/bash -x
#
# Compare models by plotting loss v Eq/No (and C/No and SNR) curves generated by inference.py
...
if [ $plot == "250227b_inf" ]; then
  ...
  declare -a model_legend=("model19_check3 AWGN Nc=30" "model19_check3 MPP Nc=30" "250217b_test AWGN Nc=10" "250217b_test MPP Nc=10")
fi
