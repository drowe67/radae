...
\item The \emph{Candidate 2} OFDM frame design \cite{FreeDV-032} contains three latent vectors $z$, so introduces an algorthmic delay of 120ms, due to OFDM framing considerations.  This amount of additional delay is tolerable in a PTT radio system, but ideally should be reduced.
