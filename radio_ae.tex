...
\end{equation}
When we have a good fine timing alignment, the vector of received samples can be expressed as:
\begin{equation}
\label{eq:rx_vec}
\bm{r} = g\bm{p} + \bm{n}
\end{equation}
...
\end{split}
\end{equation}
If we assume the dot product of the noise and pilot terms e.g. $\bm{n}^H \bm{p}$ is small:
\begin{equation}
