...
\begin{tabular}{l l l}
 ...
 \hline
\end{tabular}
\caption{Estimates of RADAE CPU and Memory Requirements. MMACS is the number of 1E6 8 bit multiply and accumulates per second.}
\label{tab:radae_resources}
\end{table}
...
The memory is mainly ML weights which are read-only.  However memory access needs to be fast to maintain the MMAC rate - each MMAC is assumed to include any required loads.
