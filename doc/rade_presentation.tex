...
\begin{frame}{RADE V2}
\begin{itemize}
\item RADE V1 is hybrid DSP/ML deisgn
\item What if we build all components using ML?
\item TOOD: block diagram
\item TODO: table comparing
\item status, some basic OTA tests, comfirming key features.  Building up and integrating ML signal processing blocks.
\end{itemize}
\end{frame}
