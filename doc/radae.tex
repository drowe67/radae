...
\begin{figure}[H]
\caption{Probability of the sum of two Rayleigh RVs exceeding a threshold. Equation (\ref{eq:rayleigh_pf12}) has a good match to the simulation histogram for $x>\num{1e-2}$.}
