...
\begin{figure}[H]
\caption{SNR versus CNR for FM demodulator model in (\ref{eq:fm_snr}) with $\beta=5/3$. SSB product detector plotted as a control.}
