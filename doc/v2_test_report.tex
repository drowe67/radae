...
\begin{tabular}{ l | c | c }
 ...
 \hline
 Number of stored file OTA samples to collect & 20 & 58 \\
...
With respect to the test goals above:
...
Only one PAPR measurement was submitted (Table \ref{tab:phase_c_take_papr}, thanks Take). This was on the baseband signal using Audacity and was consistent with the simulation results. As further work it would be desirable to obtain a measurement at the PA RF output.
...
\item If any issues are encountered, explore and fix bugs.
...
The procedure for testing are documented \href{https://github.com/drowe67/radae/README.md#testing-rade}{here}.  Any PTT results must be from an application of radio that has RADE V2 integration verified using \href{https://github.com/drowe67/radae/README.md#verifying-rade-integration}{this} procedure.  
