...
| Platform (OS + version) | Ubuntu 24.04.5 LTS, kernel 6.17.0-1022-azure, x86\_64 (loopback)<br/>Ubuntu 26.01.1 LTS, kernel 7.0.0-30-generic, x86\_64 (OTAC) |
...
Photo of test setup:
![](003-freedv-gui-linux.jpg)

Reproduction notes:
```
Use pavucontrol or similar to set the USB audio device's volume level (input and output) to 50%.

Command line:
FREEDV_BINARY=./FreeDV-3.0.0-dev-69473-x86_64.AppImage  FREEDV_COMPUTER_TO_SPEAKER_DEVICE=alsa_output.pci-0000_c5_00.6.analog-stereo FREEDV_RADIO_TO_COMPUTER_DEVICE=alsa_input.usb-GeneralPlus_USB_Audio_Device-00.mono-fallback FREEDV_COMPUTER_TO_RADIO_DEVICE=alsa_output.usb-GeneralPlus_USB_Audio_Device-00.analog-stereo FREEDV_MICROPHONE_TO_COMPUTER_DEVICE=alsa_input.pci-0000_c5_00.6.analog-stereo ctest -V -R rade_loss
```
